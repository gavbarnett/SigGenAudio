  ...
  return function(e) {
    ...
    function n(e, t, r, n) {
      var a = e.DenseMatrix,
        ...
        s = function(e, t, r, n, i, a, o) {
          var u = [];
          if (t === r.length - 1)
            for (var c = 0; c < n; c++) u[c] = o ? e(a, i[c]) : e(i[c], a);
          else
            for (var f = 0; f < n; f++) u[f] = s(e, t + 1, r, r[t + 1], i[f], a, o);
          return u
        };
      return o
    }
    ...
    function n(e, t, r, n) {
      var i = e.DenseMatrix,
        ...
        s = function(e, t, r, n, i, a) {
          var o = [];
          if (t === r.length - 1)
            for (var u = 0; u < n; u++) o[u] = e(i[u], a[u]);
          else
            for (var c = 0; c < n; c++) o[c] = s(e, t + 1, r, r[t + 1], i[c], a[c]);
          return o
        };
      return o
    }
    ...
    t.isString = function(e) {
      ...
      for (var t = String(e), r = "", n = 0; n < t.length;) {
        var i = t.charAt(n);
        "\\" === i ? (r += i, n++, i = t.charAt(n), "" !== i && '"\\/bfnrtu'.indexOf(i) !== -1 || (r += "\\"), r += i) : r += '"' === i ? '\\"' : i, n++
      }
      return '"' + r + '"'
    }
  }, function(e, t, r) {
      ...
      var s = r(4),
        ...
        T = function(e, t) {
          ...
          for (var b = [], N = [], E = [], M = new d({
            ...
            for (var _ = T + 1, S = 0; S < m; S++) {
              var C = u[S][T];
              if (!x(C, w))
                for (var z = i[S], k = i[S + 1], B = z; B < k; B++) {
                  var P = n[B];
        ...
        _ = function(e, t) {
          ...
          for (var w, b, N, E, M, A, O, T, _ = v ? [] : void 0, S = [], C = [], z = new d({
            ...
            C[P] = S.length;
            var I = P + 1;
            for (M = p[P], A = p[P + 1], E = M; E < A; E++)
              if (T = l[E], v)
                for (b = a[T], N = a[T + 1], w = b; w < N; w++) O = i[w], B[O] !== I ? (B[O] = I, S.push(O), k[O] = x(u[E], n[w])) : k[O] = y(k[O], x(u[E], n[w]));
              else
                for (b = a[T], N = a[T + 1], w = b; w < N; w++) O = i[w], B[O] !== I && (B[O] = I, S.push(O));
            if (v)
              for (var R = C[P], U = S.length, q = R; q < U; q++) {
                var L = S[q];
                _[q] = k[L]
              }
          }
    ...
    function n(e, t, n, u, c) {
      ...
      var h = n(r(7)).register,
        ...
        d = n(r(137));
      return f.prototype = new m, f.prototype.type = "SymbolNode", f.prototype.isSymbolNode = !0, h(f.prototype.type, l), f.prototype.forEach = function(e) {}, f.prototype.map = function(e) {
        return this.clone()
    ...
    function n(e, t, n, o) {
      ...
      function k() {
        ...
        for (e = B(), t = e, r = {
          ...
          if (r.hasOwnProperty(ye)) n = ye, i = r[n], m(), t = B(), e = new ae(n, i, [e, t]);
          else {
    ...
    function n(e, t, n, o) {
      ...
      return s.prototype = new l, s.prototype.type = "ConstantNode", s.prototype.isConstantNode = !0, f(s.prototype.type, u), s.prototype.forEach = function(e) {}, s.prototype.map = function(e) {
        return this.clone()
    ...
    function n(e, t, n, p, h) {
      ...
      function d(e, t, r) {
        ...
        if (e.fn.isSymbolNode) {
          var h = e.fn.name,
            ...
            v = "function" == typeof d && 1 == d.rawArgs;
        ...
        if (e.fn.isAccessorNode && e.fn.index.isObjectProperty()) {
          ...
          var y = x(e.fn.object, t, r),
            w = a(e.fn.index.getObjectProperty());
      ...
      m.prototype.toString = function(e) {
        ...
        return e && "object" == typeof e.handler && s(e.handler, r) && (t = e.handler[r](this, e)), "undefined" != typeof t ? t : N.call(this, e)
    ...
    function n(e, t, n, f, l) {
      ...
      function m(e, t, r, n) {
        ...
        if (2 === r.length) {
          var l, p = c.getPrecedence(r[0], t),
            h = c.isAssociativeWith(e, r[0], t);
          l = null !== p && (p === i && "right" === a && !h || p < i);
          var m, d = c.getPrecedence(r[1], t),
            g = c.isAssociativeWith(e, r[1], t);
    ...
    function n(e, t, n, u) {
      ...
      function l(e, t, r, n) {
        ...
        if (i.forEach(function(e, t) {
          ...
          for (c = o - 1, a = u.length; c < a; c++) u[c] || (u[c] = n);
        return u.join("")
      }
      var p = n(r(0)),
        h = u("subset", {
          ...
          var t = {
            ...
            r = function(e, t, r) {
              ...
              for (var c, f = []; f.length < t;) {
                if ("undefined" == typeof r) c = e[Math.floor(p() * u)];
                else
                  for (var h = p() * i, a = 0, s = e.length; a < s; a++)
                    if (h -= r[a], h < 0) {
                      c = e[a];
                      break
                    }
            ...
            c = function(e, t, r, n) {
              ...
              if (e = e.slice(0), e.length > 1)
                for (var a = 0, i = e.shift(); a < i; a++) o.push(c(e, t, r, n));
              else
                for (var a = 0, i = e.shift(); a < i; a++) o.push(n(t, r));
              return o
            };
          return t
        }(r)
      ...
      var o = n(r(10)),
        ...
        u = function(e, t, r) {
          ...
          for (M = 0; M < x; M++) {
            ...
            if (k && B)
              for (A = C[M]; A < S.length;) E = S[A], P[E] === R ? (_[A] = k[E], A++) : I[E] === R ? (_[A] = B[E], A++) : S.splice(A, 1)
          }
    ...
    function n(e, t, n, s) {
      ...
      function f(e, t) {
        t || (t = "keep");
        var r = g.getPrecedence(e, t),
          n = g.getPrecedence(e.value, t);
    ...
    function n(e, t, n, s) {
      ...
      return u.prototype = new p,
        u.prototype.type = "ObjectNode", u.prototype.isObjectNode = !0, f(u.prototype.type, c), u.prototype.forEach = function(e) {
      ...
      var o = n(r(0)),
        ...
        x = function(e) {
          ...
          for (r = 0; r < o; r++) {
            ...
            if (r !== M && (b[r] = [b[M], b[M] = b[r]][0], g._swapRows(r, M, d)), r < i)
              for (t = r + 1; t < i; t++) {
                var S = d[t][r];
          ...
          for (r = 0; r < o; r++)
            for (t = 0; t < i; t++) 0 === r && (t < o && (x[t] = []), v[t] = []), t < r ? (t < o && (x[t][r] = d[t][r]), r < i && (v[t][r] = 0)) : t !== r ? (t < o && (x[t][r] = 0), r < i && (v[t][r] = d[t][r])) : (t < o && (x[t][r] = d[t][r]), r < i && (v[t][r] = 1));
          var C = new g({
              data: v,
              size: y
            }),
    ...
    function n(e, t, n, i, a) {
          ...
          switch (a) {
            ...
            case "object":
              if (n = {
                  l: o(d(i.l)),
                  r: o(d(i.r))
                }, i.context && (n.evaluate = i.context), i.evaluate && (n.evaluate = d(i.evaluate)), n.l.isOperatorNode && M(n.l)) {
                var c = _(n.l),
                  f = u();
                n.expanded = {}, n.expanded.l = c([n.l.clone(), f]), A(n.expanded.l), O(n.expanded.l), n.expanded.r = c([n.r, f])
              }
              break;
            case "function":
              n = i;
      ...
      function c(e, t) {
        var r, n, i = [],
          a = _(e);
        if (E(e, t))
          for (var o = 0; o < e.args.length; o++) n = e.args.slice(0), n.splice(o, 1), r = 1 === n.length ? n[0] : a(n), i.push(a([e.args[o], r]));
        else n = e.args.slice(1), r = 1 === n.length ? n[0] : a(n), i.push(a([e.args[0], r]));
        return i
      }
      ...
      function l(e, t) {
        ...
        for (var n, i = 0; i < e.length; i++)
          for (var a = 0; a < t.length; a++) n = f(e[i], t[a]), n && r.push(n);
        return r
      }
      ...
      function h(e, t, r) {
        ...
        if (e instanceof y && t instanceof y || e instanceof v && t instanceof v) {
          if (e instanceof y) {
            if (e.op !== t.op || e.fn !== t.fn) return []
          } else if (e instanceof v && e.name !== t.name) return [];
          ...
          if (a.hasOwnProperty(e.name)) {
            if (!C[e.name]) throw new Error("Built in constant: " + e.name + " is not supported by simplify.");
      ...
      function m(e, t) {
        if (e instanceof g && t instanceof g) {
          ...
          if (!(e instanceof y && t instanceof y || e instanceof v && t instanceof v)) return !1;
          if (e instanceof y) {
            if (e.op !== t.op || e.fn !== t.fn) return !1
          } else if (e instanceof v && e.name !== t.name) return !1;
      ...
      var d = n(r(30)),
        ...
        S = i("simplify", {
          ...
          "Node, Array": function(e, t) {
            t = s(t);
            for (var r = o(e), n = {}, i = r.toString({
                parenthesis: "all"
              }); !n[i];) {
              n[i] = !0, z = 0;
              for (var a = 0; a < t.length; a++) "function" == typeof t[a] ? r = t[a](r) : (A(r), r = k(r, t[a])), T(r);
              i = r.toString({
                parenthesis: "all"
              })
            }
      ...
      var z = 0,
        k = i("applyRule", {
          "Node, Object": function(e, t) {
            var r = e;
            if (r instanceof y || r instanceof v) {
              if (r.args)
                for (var n = 0; n < r.args.length; n++) r.args[n] = k(r.args[n], t)
            } else r instanceof x && r.content && (r.content = k(r.content, t));
            var i = t.r,
              a = h(t.l, r)[0];
            return !a && t.expanded && (i = t.expanded.r, a = h(t.expanded.l, r)[0]), a && (r = i.clone(), r = r.transform(function(e, t, r) {
      ...
      var o = n(r(10)),
        ...
        u = function(e, t, r) {
          ...
          for (M = 0; M < x; M++) {
            ...
            var P = M + 1;
            if (k)
              for (O = m[M], T = m[M + 1], A = O; A < T; A++) E = h[A], B[E] = P, k[E] = p[A];
    ...
    function n(e, t, n, s, u) {
      ...
      c.parse = function(r, n) {
        ...
        for (var s = 1, u = !1, l = [], p = 1;;) {
          ...
          for (var E = 0; E < j.length; E++) i.dimensions[E] += (w.unit.dimensions[E] || 0) * b;
          for (f();
            ")" === R;) {
      ...
      return c.createUnit = function(e, t) {
        ...
        if (a) {
          ...
          var m = e + "_STUFF";
          if (j.indexOf(m) >= 0) throw new Error('Cannot create new base unit "' + e + '": a base unit with that name already exists (and cannot be overridden)');
          j.push(m);
          for (var g in F) F.hasOwnProperty(g) && (F[g].dimensions[j.length - 1] = 0);
          for (var d = {
              dimensions: []
            }, u = 0; u < j.length; u++) d.dimensions[u] = 0;
          d.dimensions[j.length - 1] = 1, d.key = m, F[m] = d, f = {
            name: e,
            value: 1,
        ...
        g = i("_derivative", {
          ...
          "FunctionNode, Object": function(e, r) {
            ...
            switch (e.name) {
              ...
              case "nthRoot":
                ...
                return n = new f("/", "divide", [new u("1", t.number), e.args[1]]), r[n] = r[e.args[1]], g(new f("^", "pow", [o, n]), r);
              case "log10":
                n = new u("10", t.number);
              case "log":
                if (n || 1 != e.args.length) {
                  if (!n && void 0 === r[e.args[1]]) return g(new f("/", "divide", [new c("log", [o]), new c("log", [e.args[1]])]), r);
            ...
            var d = g(o, r);
            return l && (d = new f("-", "unaryMinus", [d])), new f(h, m, [d, i])
          },
          "OperatorNode, Object": function(e, r) {
            ...
            switch (e.op) {
              case "+":
              case "-":
                return 1 == e.args.length ? new f(e.op, e.fn, [g(n, r)]) : new f(e.op, e.fn, [g(n, r), g(i, r)]);
              case "*":
                if (void 0 !== r[n] || void 0 !== r[i]) {
                  var a = void 0 !== r[n] ? [n.clone(), g(i, r)] : [i.clone(), g(n, r)];
                  return new f("*", "multiply", a)
                }
                return new f("+", "add", [new f("*", "multiply", [g(n, r), i.clone()]), new f("*", "multiply", [n.clone(), g(i, r)])]);
              case "/":
                return void 0 !== r[i] ? new f("/", "divide", [g(n, r), i]) : void 0 !== r[n] ? new f("*", "multiply", [new f("-", "unaryMinus", [n]), new f("/", "divide", [g(i, r), new f("^", "pow", [i.clone(), new u("2", t.number)])])]) : new f("/", "divide", [new f("-", "subtract", [new f("*", "multiply", [g(n, r), i.clone()]), new f("*", "multiply", [n.clone(), g(i, r)])]), new f("^", "pow", [i.clone(), new u("2", t.number)])]);
              case "^":
                if (void 0 !== r[n]) return !n.isConstantNode || "0" != n.value && "1" != n.value ? new f("*", "multiply", [e, new f("*", "multiply", [new c("log", [n.clone()]), g(i.clone(), r)])]) : new u("0", t.number);
                if (void 0 !== r[i]) {
                  if (i.isConstantNode) {
                    var o = i.value;
                  ...
                  return new f("*", "multiply", [i.clone(), new f("*", "multiply", [g(n, r), s])])
                }
                return new f("*", "multiply", [new f("^", "pow", [n.clone(), i.clone()]), new f("+", "add", [new f("*", "multiply", [g(n, r), new f("/", "divide", [i.clone(), n.clone()])]), new f("*", "multiply", [g(i, r), new c("log", [n.clone()])])])]);
              case "%":
              case "mod":
              default:
    ...
    function n(e, t, n, i, a) {
      ...
      function l(e, t, r) {
        return t.reduce(function(t, n) {
          if (t.isNode || n.isNode) t.isNode ? n.isNode || (n = w(n)) : t = w(t);
          else {
            try {
              return s(e, [t, n])
            } catch (e) {}
      ...
      function p(e) {
        switch (e.type) {
          ...
          case "FunctionNode":
            if (a[e.name] && a[e.name].rawArgs) return e;
          case "OperatorNode":
            var t, r, n = e.fn.toString(),
              i = v(e);
            if (1 === e.args.length) t = [p(e.args[0])], r = t[0].isNode ? i(t) : s(n, t);
            else if (d(e))
              if (t = g(e), t = t.map(p), m(n)) {
                for (var o = [], u = [], c = 0; c < t.length; c++) t[c].isNode ? u.push(t[c]) : o.push(t[c]);
                o.length > 1 ? (r = l(n, o, i), u.unshift(r), r = l(n, u, i)) : r = l(n, t, i)
              } else r = l(n, t, i);
            else t = e.args.map(p), r = l(n, t, i);
            return r;
          case "ParenthesisNode":
            return p(e.content);
          case "AccessorNode":
    ...
    function n(e, t, n) {
      var i = n(r(69)),
        ...
        f = function(e, t) {
          ...
          var f = l(e, t, n, s, c);
          a(f, d, null);
          for (var g, v, y, x, w, b, N, E, M, A, O, T, _, S, C, z, k = f._index, B = f._ptr, P = B[s], I = [], R = [], U = 0, q = s + 1, L = 2 * (s + 1), j = 3 * (s + 1), F = 4 * (s + 1), D = 5 * (s + 1), $ = 6 * (s + 1), G = 7 * (s + 1), H = I, V = p(s, B, R, U, j, H, L, G, q, $, F, D), Z = h(s, B, R, D, F, $, c, q, j, H, L), W = 0; Z < s;) {
            for (y = -1; W < s && (y = R[j + W]) == -1; W++);
            R[L + y] != -1 && (H[R[L + y]] = -1), R[j + W] = R[L + y];
            var Y = R[F + y],
              X = R[q + y];
            Z += X;
            var J = 0;
            ...
            var Q = B[y],
              ...
              ee = K;
            for (x = 1; x <= Y + 1; x++) {
              for (x > Y ? (b = y, N = Q, E = R[U + y] - Y) : (b = k[Q++], N = B[b], E = R[U + b]), w = 1; w <= E; w++) g = k[N++], (M = R[q + g]) <= 0 || (J += M, R[q + g] = -M, k[ee++] = g, R[L + g] != -1 && (H[R[L + g]] = H[g]), H[g] != -1 ? R[L + H[g]] = R[L + g] : R[j + R[D + g]] = R[L + g]);
              b != y && (B[b] = i(y), R[$ + b] = 0)
            }
            ...
            for (R[D + y] = J, u = Math.max(u, J), V = m(V + u, u, R, $, s), A = K; A < ee; A++)
              if (g = k[A], !(R[q + g] >= 0))
                for (C = H[g], g = R[G + C], R[G + C] = -1; g != -1 && R[L + g] != -1; g = R[L + g], V++) {
            ...
            for (Q = K, A = K; A < ee; A++) g = k[A], (M = -R[q + g]) <= 0 || (R[q + g] = M, z = R[D + g] + J - M, z = Math.min(z, s - Z - M), R[j + z] != -1 && (H[R[j + z]] = g), R[L + g] = R[j + z], H[g] = -1, R[j + z] = g, W = Math.min(W, z), R[D + g] = z, k[Q++] = g);
            R[q + y] = X, 0 === (R[U + y] = Q - K) && (B[y] = -1, R[$ + y] = 0), 0 !== Y && (P = Q)
          }
          for (g = 0; g < s; g++) B[g] = i(B[g]);
          for (v = 0; v <= s; v++) R[j + v] = -1;
          for (v = s; v >= 0; v--) R[q + v] > 0 || (R[L + v] = R[j + B[v]], R[j + B[v]] = v);
          for (b = s; b >= 0; b--) R[q + b] <= 0 || B[b] != -1 && (R[L + b] = R[j + B[b]], R[j + B[b]] = b);
          for (y = 0, g = 0; g <= s; g++) B[g] == -1 && (y = o(g, y, R, j, L, I, $));
      ...
      var i = n(r(56)),
        ...
        o = function(e, t, r, n) {
          ...
          var M = [],
            ...
            T = A._ptr;
          for (u = 0; u < d; u++)
            for (s = r[u], M[s] = v[b + s] == -1 ? 1 : 0; s != -1 && v[b + s] == -1; s = t[s]) v[b + s] = u;
          if (n) {
      ...
      var i = n(r(101)),
        ...
        s = function(e, t, r, n, s) {
          ...
          for (n[0] = e; d >= 0;) {
            ...
            var v = 1;
            for (c = n[m + d], f = g < 0 ? 0 : o(p[g + 1]); c < f; c++)
              if (u = l[c], !i(p, u)) {
                n[m + d] = c, n[++d] = u, v = 0;
                break
              }
    ...
    function n() {
      var e = function(e, t, r, n, i, a, o) {
        ...
        if (r[i + e] = r[n + t], c = r[a + e], r[a + e] = t, c === -1) l = 1, f = e;
        else {
        ...
        u = function(e, t, r, n, u, c, f) {
          ...
          for (var M = E; M < x; M++) {
            var A = n[M],
              O = c ? c[A] : A;
            if (!(O < 0))
              for (p = v[O], h = v[O + 1], u[A] = i(u[A], d[f ? p : h - 1]), l = f ? p + 1 : p, m = f ? h : h - 1; l < m; l++) {
                var T = g[l];
                u[T] = o(u[T], a(d[l], u[A]))
              }
          }
    ...
    function n(e, t, n) {
      var i = n(r(354)),
        ...
        c = function(e, t, r) {
          ...
          if (r) {
            ...
            if (h.cp = u(m, h.parent, d, 1), m && h.parent && h.cp && f(m, h))
              for (h.unz = 0, n = 0; n < p; n++) h.unz += h.cp[n]
        ...
        f = function(e, t) {
          ...
          for (s = 0; s < a; s++) m[s] = -1;
          for (u = o - 1; u >= 0; u--)
            for (f = r[u], l = r[u + 1], c = f; c < l; c++) m[n[c]] = u;
    ...
    function n(e, t, n, d) {
      ...
      var b = function(e, t) {
        ...
        N = function(e, t, r, n) {
          ...
          if (r && r.isMatrix === !0 ? (i = r.size(), r = r.toArray()) : i = o.size(r), c) {
            ...
            for (var p = t.min()[0], h = t.min()[1], m = i[0], d = i[1], g = 0; g < m; g++)
              for (var v = 0; v < d; v++) {
                var y = r[g][v];
                e.set([g + p, v + h], y, n)
              }
      ...
      g.prototype.reshape = function(e, t) {
        ...
        for (var m = 0; m < o.length; m++) {
          var i = s[m],
            a = n[m],
            d = o[m],
            g = E(i, r._ptr[a], r._ptr[a + 1], r._index);
      ...
      var T = function(e, t, r, n, i, a, o) {
        ...
        for (var p = function(e, t, r) {
          ...
          for (var v = e._ptr[m], x = e._ptr[m + 1], w = t, b = v; b < x; b++) {
            ...
            if (N >= t && N <= r) {
              if (!o)
                for (var E = w; E < N; E++) p(0, E - t, m - n);
              p(e._values[b], N - t, m - n)
            }
            w = N + 1
          }
          if (!o)
            for (var M = w; M <= r; M++) p(0, M - t, m - n)
        }
      ...
      g.prototype.forEach = function(e, t) {
        ...
        for (var r = this, n = this._size[0], i = this._size[1], a = 0; a < i; a++) {
          for (var o = this._ptr[a], s = this._ptr[a + 1], u = 0, c = o; c < s; c++) {
            var f = this._index[c];
            if (!t)
              for (var l = u; l < f; l++) e(0, [l, a], r);
            e(this._values[c], [f, a], r), u = f + 1
          }
          if (!t)
            for (var p = u; p < n; p++) e(0, [p, a], r)
        }
      ...
      var _ = function(e, t, r, n, i) {
        var a, o, u = n[0],
          ...
          f = [];
        for (a = 0; a < u; a++)
          for (f[a] = [], o = 0; o < c; o++) f[a][o] = 0;
        for (o = 0; o < c; o++)
          for (var l = r[o], p = r[o + 1], h = l; h < p; h++) a = t[h], f[a][o] = e ? i ? s.clone(e[h]) : e[h] : 1;
        return f
      };
    ...
    e.exports = function(e, t, r, n, i, a, o, s, u, c, f) {
      var l, p, h, m, d = e._values,
        ...
        y = o._index;
      if (n)
        for (p = v[t], h = v[t + 1], l = p; l < h; l++) m = g[l], r[m] !== a ? (r[m] = a, y.push(m), c ? (n[m] = u ? s(d[l], f) : s(f, d[l]), i[m] = a) : n[m] = d[l]) : (n[m] = u ? s(d[l], n[m]) : s(n[m], d[l]), i[m] = a);
      else
        for (p = v[t], h = v[t + 1], l = p; l < h; l++) m = g[l], r[m] !== a ? (r[m] = a, y.push(m)) : i[m] = a
    }
  }, function(e, t) {
    e.exports = "3.13.1"
  }, function(e, t, r) {
    ...
    ! function(i) {
      ...
      function f(e, t, r, n) {
        ...
        e: if (null != t) {
          ...
          if (a = t - i, a < 0) a += Pe, o = t, f = l[p = 0], u = f / _e(10, i - o - 1) % 10 | 0;
          else if (p = Math.ceil((a + 1) / Pe), s = l.length, p >= s) {
            if (!n) break e;
            for (; s++ <= p;) l.push(0);
          ...
          if (0 == a ? (l.length = p, s = 1, p--) : (l.length = p + 1, s = _e(10, Pe - a), l[p] = o > 0 ? (f / _e(10, i - o) % _e(10, o) | 0) * s : 0), c)
            for (;;) {
              if (0 == p) {
      ...
      function b(e, t) {
        ...
        for (o = x.e, n > 1 ? (x = new N("0." + r), o++) : x = new N(n + "." + r.slice(1)), d = x, l = u = x = Le(x.minus(1), x.plus(1), m, 1), g = f(x.times(x), m, 1), i = 3;;) {
          if (u = f(u.times(g), m, 1), p = l.plus(Le(u, new N(i), m, 1)), a(p.d).slice(0, m) === a(l.d).slice(0, m)) {
            if (l = l.times(2), 0 !== o && (l = l.plus(h(N, m + 2, M).times(o + ""))), l = Le(l, new N(v), m, 1), null != t) return N.precision = M, l;
            if (!s(l.d, m - y, E, c)) return f(l, N.precision = M, E, Ne = !0);
            N.precision = m += y, p = u = x = Le(d.minus(1), d.plus(1), m, 1), g = f(x.times(x), m, 1), i = c = 1
          }
          l = p, i += 2
        }
      }
      ...
      function M(e, t) {
        ...
        if (Ce.test(t)) r = 16, t = t.toLowerCase();
      ...
      function T(e, t) {
        ...
        if (r = t.divToInt(i), r.isZero()) de = n ? 3 : 2;
        else {
      ...
      function _(e, t, r, n) {
        ...
        if (v ? (o(r, 1, ve), void 0 === n ? n = g.rounding : o(n, 0, 8)) : (r = g.precision, n = g.rounding), e.isFinite()) {
          ...
          if (m[0]) {
            if (s < 0 ? a-- : (e = new g(e), e.d = m, e.e = a, e = Le(e, d, r, n, 0, i), m = e.d, a = e.e, p = me), s = m[r], c = i / 2, p = p || void 0 !== m[r + 1], p = n < 4 ? (void 0 !== s || p) && (0 === n || n === (e.s < 0 ? 3 : 2)) : s > c || s === c && (4 === n || p || 6 === n && 1 & m[r - 1] || n === (e.s < 0 ? 8 : 7)), m.length = r, p)
      ...
      function ie(e) {
        var t, r, n, i, a = 0,
          s = new this(1),
          u = [];
        if (void 0 === e ? e = this.precision : o(e, 1, ve), n = Math.ceil(e / Pe), this.crypto)
          if (crypto.getRandomValues)
            for (t = crypto.getRandomValues(new Uint32Array(n)); a < n;) i = t[a], i >= 429e7 ? t[a] = crypto.getRandomValues(new Uint32Array(1))[0] : u[a++] = i % 1e7;
          else {
      ...
      qe.absoluteValue = qe.abs = function() {
        ...
        if (t = a.precision, r = a.rounding, a.precision = t + Math.max(i.e, i.sd()) + 4, a.rounding = 1, n = i.d.length, n < 3) i = O(a, 2, i, i, !0);
        else {
        ...
        if (Ne = !1, c = d + v, u = b(p, c), n = t ? h(m, c + 10) : b(e, c), l = Le(u, n, c, 1), s(l.d, i = d, g))
          do
        ...
        var t, r = this,
          n = r.constructor;
        return e = new n(e), !r.d || !e.s || e.d && !e.d[0] ? new n(NaN) : !e.d || r.d && !r.d[0] ? f(new n(r), n.precision, n.rounding) : (Ne = !1, 9 == n.modulo ? (t = Le(r, e.abs(), 0, 3, 1), t.s *= e.s) : t = Le(r, e, 0, n.modulo, 1), t = t.times(e), Ne = !0, r.minus(t))
        ...
        var t, r, n, i, o, s, u, c, f, l, p, h, m = this,
          ...
          v = m.constructor;
        if (!g) return new v(m);
        if (f = r = new v(1), n = c = new v(0), t = new v(n), o = t.e = d(g) - m.e - 1, s = o % Pe, t.d[0] = _e(10, s < 0 ? Pe + s : s), null == e) e = o > 0 ? t : f;
        else {
          if (u = new v(e), !u.isInt() || u.lt(f)) throw Error(Me + u);
          e = u.gt(t) ? o > 0 ? t : f : u
        }
        for (Ne = !1, u = new v(a(g)), l = v.precision, v.precision = o = g.length * Pe * 2; p = Le(u, t, 0, 1, 1), i = r.plus(p.times(n)), 1 != i.cmp(e);) r = n, n = i, i = f, f = c.plus(p.times(i)), c = i, i = t, t = u.minus(p.times(i)), u = i;
      ...
      var Le = function() {
        ...
        return function(n, i, a, o, s, u) {
          var c, l, p, h, m, d, g, v, y, x, w, b, N, E, M, A, O, T, _, S, C = n.constructor,
            z = n.s == i.s ? 1 : -1,
            k = n.d,
            B = i.d;
          ...
          if (B[p] > (k[p] || 0) && l--, null == a ? (E = a = C.precision, o = C.rounding) : E = s ? a + (n.e - i.e) + 1 : a, E < 0) x.push(1), d = !0;
          else {
            if (E = E / m + 2 | 0, p = 0, 1 == _) {
              for (h = 0, B = B[0], E++;
                (p < O || h) && E--; p++) M = h * u + (k[p] || 0), x[p] = M / B | 0, h = M % B | 0;
              d = h || p < O
            } else {
      ...
      u.REDUCE = 1, u.prototype = {
        ...
        toString: function() {
          ...
          for (var n = String(t).split(""), i = 0, a = [~this.s ? "" : "-", "", ""], o = "", s = d(t, r), c = g(t, r, s), f = -1, l = 1, p = 15 + s + c + n.length, h = 0; h < p; h++, i *= 10) {
            if (h < n.length ? i += Number(n[h]) : (l = 2, f++), s > 0)
              if (f === c) a[l] += o + "(", o = "";
              else if (f === s + c) {
              a[l] += o + ")";
              break
    ...
    (function(t) {
      ...
      e.exports = function(t, c) {
        ...
        var l = c && c.entropy || !1,
          d = [],
          g = (i(n(l ? [t, o(f)] : 0 in arguments ? t : a(), 3), d), new r(d));
        return i(o(g.S), f),
          function() {
      ...
      function e() {
        ...
        function o(e, t) {
          ...
          for (var n = 0; n < r.length; n++) {
            var i = new a(r[n]);
            if (this.params[n] = i, i.anyType && (this.anyType = !0), n === r.length - 1) this.varArgs = i.varArgs;
          ...
          for (i.sort(function(e, t) {
            ...
            if (t = i[r], t.varArgs)
              for (var h = t.params.length - 1, m = t.params[h], d = 0; d < m.types.length;) {
                if (m.conversions[d])
                  for (var v = m.types[d], y = 0; y < i.length; y++) {
                    var x = i[y],
                      w = x.params[h];
        ...
        i.prototype.add = function(e, t) {
          ...
          if (this.param) {
            ...
            if (this.param.varArgs)
              if (this.param.anyType) n.push(r + "if (arguments.length > " + i + ") {"), n.push(r + "  var varArgs = [];"), n.push(r + "  for (var i = " + i + "; i < arguments.length; i++) {"), n.push(r + "    varArgs.push(arguments[i]);"), n.push(r + "  }"), n.push(this.signature.toCode(e, r + "  ")), n.push(r + "}");
              else {
            ...
            else if (this.param.anyType) n.push(r + "// type: any"), n.push(this._innerCode(e, r));
            else {
